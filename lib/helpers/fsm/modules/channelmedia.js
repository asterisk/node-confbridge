...
function ChannelMediaModule() {
   ...
   *
   * @param {Object} channel - the channel to start moh for
   */
  this.startMoh = function(channel) {
    var startMoh = Q.denodeify(channel.startMoh.bind(channel));
    startMoh()
      .catch(function (err) {
        console.error(err);
      })
   ...
   *
   * @param {Object} channel - the channel to stop moh for
   */
  this.stopMoh = function(channel) {
    var stopMoh = Q.denodeify(channel.stopMoh.bind(channel));
    stopMoh()
      .catch(function (err) {
        console.error(err);
      })
